  ...
  static final BudgetTemplate zeroBased = BudgetTemplate(
    ...
    categories: [
      BudgetCategoryTemplate(
        ...
        name: 'Food & Dining',
        amount: 400.0,
        description: 'Groceries, restaurants, coffee shops, delivery',
        icon: 'restaurant',
        color: 0xFFF59E0B,
      ),
      BudgetCategoryTemplate(
      ...
      BudgetCategoryTemplate(
        ...
        name: 'Healthcare',
        amount: 150.0,
        description: 'Health, auto, home, life insurance, medical expenses',
        icon: 'local_hospital',
        color: 0xFFDC2626,
      ),
      BudgetCategoryTemplate(
      ...
      BudgetCategoryTemplate(
        ...
        name: 'Other',
        amount: 100.0,
        description: 'Miscellaneous expenses and savings',
        icon: 'category',
        color: 0xFF64748B,
      ),
    ],
  ...
  static final BudgetTemplate envelope = BudgetTemplate(
    ...
    categories: [
      BudgetCategoryTemplate(
        ...
        name: 'Food & Dining',
        amount: 500.0,
        description: 'Groceries, restaurants, and weekly food shopping',
        icon: 'restaurant',
        color: 0xFFF59E0B,
      ),
      BudgetCategoryTemplate(
        ...
        name: 'Transportation',
        amount: 200.0,
        description: 'Fuel, car maintenance, and transportation costs',
        icon: 'directions_car',
        color: 0xFFEF4444,
      ),
      BudgetCategoryTemplate(
        ...
        name: 'Entertainment',
        amount: 150.0,
        description: 'Movies, games, outings, and entertainment',
        icon: 'movie',
        color: 0xFFF97316,
      ),
      BudgetCategoryTemplate(
        ...
        name: 'Shopping',
        amount: 100.0,
        description: 'Clothing, toiletries, and personal items',
        icon: 'shopping_bag',
        color: 0xFFEC4899,
      ),
      BudgetCategoryTemplate(
        ...
        name: 'Utilities',
        amount: 100.0,
        description: 'Cleaning supplies, repairs, and home maintenance',
        icon: 'bolt',
        color: 0xFF06B6D4,
      ),
      BudgetCategoryTemplate(
        ...
        name: 'Other',
        amount: 50.0,
        description: 'Miscellaneous expenses and unexpected costs',
        icon: 'category',
        color: 0xFF64748B,
      ),
    ],
